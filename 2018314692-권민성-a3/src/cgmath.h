...
struct mat4
{
	...
	static mat4 rotateX(float theta) { return mat4().set_rotateX(theta); }
	static mat4 rotateY(float theta) { return mat4().set_rotateY(theta); }
	static mat4 rotateZ(float theta) { return mat4().set_rotateZ(theta); }
	...
	inline mat4& set_rotateX(float theta)
	{
		...
		a[4] = 0.0f;	a[5] = c;		a[6] = -s;		a[7] = 0.0f;
		a[8] = 0.0f;	a[9] = s;		a[10] = c;		a[11] = 0.0f;
	...
	{
		float c = cos(theta), s = sin(theta);
		a[0] = c;		a[1] = 0.0f;	a[2] = s;		a[3] = 0.0f;
		a[4] = 0.0f;	a[5] = 1.0f;	a[6] = 0.0f;	a[7] = 0.0f;
		a[8] = -s;		a[9] = 0.0f;	a[10] = c;		a[11] = 0.0f;
		a[12] = 0.0f;	a[13] = 0.0f;	a[14] = 0.0f;	a[15] = 1.0f;
		return *this;
	}
	...
	{
		float c = cos(theta), s = sin(theta);
		a[0] = c;		a[1] = -s;		a[2] = 0.0f;	a[3] = 0.0f;
		a[4] = s;		a[5] = c;		a[6] = 0.0f;	a[7] = 0.0f;
